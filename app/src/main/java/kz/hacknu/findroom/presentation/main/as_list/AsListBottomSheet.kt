package kz.hacknu.findroom.presentation.main.as_list
 ...
 * on: 20.03.2021
 */
class AsListBottomSheet () : BaseBottomSheet() {
    ...
    ): View? = inflater.inflate(R.layout.bottom_sheet_as_list, container, false)
